        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <!-- input 事件 输入的时候同步触发
                      blur事件  失去 焦点的时候触发,不管内容有没有发生变化
                      change事件 失去焦点的时候触发,但是内容必须发生变化
                -->
                <!-- parseInt 处理如果输入是小数 -->
...
<script>
  ...
  export default {
    ...
    beforeMount() { //一般在beformount中处理数据,处理完成后期可以直接使用
