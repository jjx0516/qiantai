<template>
  <div class="cart">
    ...
    <div class="cart-main">
      ...
      <div class="cart-body">
        <div v-if="shopCartList.length > 0">
          <ul
            class="cart-list"
            v-for="(shopCart, index) in shopCartList[0].cartInfoList"
            :key="shopCart.id"
          >
            ...
            <li class="cart-list-con5">
              ...
              <input
                ...
                class="itxt"
                @change="
                  changeCartNum(shopCart, $event.target.value * 1, false)
                "
              />
              <a
                href="javascript:void(0)"
    ...
    <div class="cart-tool" v-if="shopCartList.length > 0">
...
export default {
  ...
  computed: {
    ...
    isAllChecked: {
      ...
      async set(val) {
        // await this.$store.dispatch('UpdateCartCheckedAll',val?1:0) 是调用UpdateCartCheckedAll异步函数
        // 他的结果是异步函数的返回值,固定的那个promise,不是函数return后面的promise.all的返回值promise
        try {
